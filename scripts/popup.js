...
function parse_response(response) {
    var popup_ads = JSON.parse(localStorage.getItem("popup_ads"));
    ...
    localStorage.setItem("popup_ads", JSON.stringify(popup_ads));
}

function isUseful(e) {
    const ad_title = e.target.value;
    var popup_ads = JSON.parse(localStorage.getItem("popup_ads"));
    var report_ads = JSON.parse(localStorage.getItem("report_ads"));
    ...
    localStorage.setItem("popup_ads", JSON.stringify(popup_ads));
    localStorage.setItem("report_ads", JSON.stringify(report_ads));
